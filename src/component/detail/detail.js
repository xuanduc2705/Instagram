...
function Detail() {
  ...
  return (
    <div className="detailpage">
      <div className="detailhomepage_nav">
      <div className={`detailNav ${isNavVisible ? '' : 'hide-nav'}`} id="main-nav">
    <Link to='/home' >
    ...
    <Link to='/home' className='detailigiconic'>
          <InstagramIcon />
    </Link>
        
        <div className='detailnav_buttons'>
            ...
            <button className='sidenav_button detailmenu'onClick={handleSearchClick} >
              <SearchIcon/>
            ...
            <button className='sidenav_button detailmenu' onClick={handleNofiClick}>
              <FavoriteBorderIcon/>
            ...
            <div className="detailprofileava">
              <Avatar 
            ...
            <button className='sidenav_button detailmenu' onClick={handleNavClose}>
              <MenuIcon/>
