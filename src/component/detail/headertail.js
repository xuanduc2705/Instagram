    ...
    <div className="headertailpage">
      <div className="htrai">
        <div className="himage">
          <img className="anh" src={tenn.ava} alt="" />
        </div>
      ...
      <div className="hinfo">
        ...
        <div className="info2">
          <span className="info21">{tenn.posts}</span>
          <span className="info22"> posts</span>
          <span className="info21">{tenn.followers}</span>
          <span className="info22"> followers</span>
          <span className="info21">{tenn.following}</span>
          <span className="info22"> following</span>
        </div>
        <div className="info3">
