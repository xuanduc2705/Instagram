  ...
  return (
    ...
    <img className='nav_logo' 
        ...
        <div className='nav_buttons'>
            <Link to='/home' style={{ textDecoration: 'none'}} className='showing'>
            <button className='sidenav_button showing' style={{marginTop:"25px",marginBottom:"25px"}}>
            <InstagramIcon/>
            ...
            <Link to='/explore' style={{ textDecoration: 'none' }}>
              {true ? (<button className='sidenav_button'>
               <ExploreOutlinedIcon />
          ...
          (direction) => (
            <DropdownButton className='sidenav_button'
              ...
              title={
                <span>
                  <MenuIcon />
                  <span className='spann' style={{color:'white'}}>More</span>
                </span>
              }
              style={{backgroundColor:'white',background:'none',color:"white"}}
            >
