  ...
  <>
    <div className="messnav">
        <div className="bentraii">
            <Link to='/home' style={{ textDecoration: 'none'}} className='messshowing'>
            <button className='sidenav_button messshowing' style={{marginTop:"25px",marginBottom:"25px"}}>
            <InstagramIcon/>
            </button>
            </Link>
        <div className='nav_buttons' style={{marginLeft:'10px'}}>
            ...
            <button className='sidenav_button2 hidding' style={{width:'40px',height:'40px',justifyContent:'center',marginLeft:'3px'}}>
            ...
            <button className='sidenav_button2 hidding' onClick={props.onClick2}>
            ...
            {['up'].map(
          (direction) => (
            <DropdownButton className='sidenav_button'
              as={ButtonGroup}
              key={direction}
              ...
              style={{backgroundColor:'white',background:'none',color:"white",margin:'0',padding:"0"}}
            >

              <Dropdown.Item eventKey="1"><IoIosSettings style={{fontSize:"25px",margin:"0 8px 0 5px"}} /> Setting</Dropdown.Item>
              <Dropdown.Item eventKey="2"><VscGraphLine style={{fontSize:"25px",margin:"0 8px 0 5px"}}/> Your activity</Dropdown.Item>
              <Dropdown.Item eventKey="3"><HiOutlineBookmark style={{fontSize:"25px",margin:"0 8px 0 5px"}}/> Saved</Dropdown.Item>
              <Dropdown.Item eventKey="4"><MdOutlineWbSunny style={{fontSize:"25px",margin:"0 8px 0 5px"}}/> Switch Appearance</Dropdown.Item>
              <Dropdown.Item eventKey="5"><GoReport style={{fontSize:"25px",margin:"0 8px 0 5px"}}/> Report a problem!</Dropdown.Item>
              ...
              <Dropdown.Item eventKey="7" onClick={handleLogout}>Log out</Dropdown.Item>
            </DropdownButton>
          ),
        )}
            </div>           
