      ...
      {mess ? (
        <div style={{ display: "flex", flexDirection: "row" }}>
          <div className="messsidebar">
            {isNavVisible && (
              <Messnav onClick={handleSearchClick} onClick2={handleNofiClick} />
            )}
            {showAnotherNav && (
              <SearchNav onClick={handleNavClose} onClick2={handleNofiClick} />
            )}
            {showAnotherNavi && (
              <NofiNav onClick={handleNavClose} onClick2={handleSearchClick} />
            )}
          </div>
        ...
        <div className="flex flex-row">
          <div className="sidebar">
            {isNavVisible && (
              <Nav onClick={handleSearchClick} onClick2={handleNofiClick} />
            )}
            {showAnotherNav && (
              <SearchNav onClick={handleNavClose} onClick2={handleNofiClick} />
            )}
